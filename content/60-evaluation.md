...
For general evaluation of the implementation, a sample generator[^sample-generator] is implemented to create a configurable number of random website objects in different namespaces.
